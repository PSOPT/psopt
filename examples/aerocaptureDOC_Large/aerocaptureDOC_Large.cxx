         ...
         adouble* xad, int iphase, Workspace* workspace)
{
   ...
   // Sensititvity matrix elements diff eqs
    ...
    adouble a41_dot = -a44*((Omega*Omega)*cos(phi)*(cos(phi)*sin(gamma)-cos(azim)*cos(gamma)*sin(phi))-mu*1.0/(r*r*r)*sin(gamma)*(J2*(Re*Re)*1.0/(r*r)*(pow(sin(phi),2.0)*(9.0/2.0)-3.0/2.0)-1.0)*2.0-J2*(Re*Re)*mu*1.0/(r*r*r*r*r)*sin(gamma)*(pow(sin(phi),2.0)*(9.0/2.0)-3.0/2.0)*2.0+(B*Cd*S_ref*p0*(v*v)*exp(B*(Re+h_0-r)))/(m*2.0)+J2*(Re*Re)*mu*1.0/(r*r*r*r*r)*cos(phi)*sin(phi)*cos(gamma*cos(azim))*1.2E+1)+a45*((cos(gamma)*(1.0/(r*r)*(v*v)+mu*1.0/(r*r*r)*(J2*(Re*Re)*1.0/(r*r)*(pow(sin(phi),2.0)*(9.0/2.0)-3.0/2.0)-1.0)*2.0+J2*(Re*Re)*mu*1.0/(r*r*r*r*r)*(pow(sin(phi),2.0)*(9.0/2.0)-3.0/2.0)*2.0)-(Omega*Omega)*cos(phi)*(cos(gamma)*cos(phi)+cos(azim)*sin(gamma)*sin(phi))+(B*Cl*S_ref*p0*(v*v)*exp(B*(Re+h_0-r))*cos(bank))/(m*2.0)+J2*(Re*Re)*mu*1.0/(r*r*r*r*r)*cos(azim)*cos(phi)*sin(gamma)*sin(phi)*1.2E+1)/v+(Cl*S_ref*k1*p0*v*exp(B*(Re+h_0-r))*sin(bank))/(m*2.0))+a43*1.0/(r*r)*v*cos(azim)*cos(gamma)+(a46*1.0/(r*r*r*r*r)*((Omega*Omega)*m*(r*r*r*r*r)*cos(phi)*sin(azim)*sin(phi)*-2.0+(m*(r*r*r)*(v*v)*pow(cos(gamma),2.0)*sin(azim)*sin(phi)*2.0)/cos(phi)+J2*(Re*Re)*m*mu*cos(phi)*sin(azim)*sin(phi)*2.4E+1+B*Cl*S_ref*p0*(r*r*r*r*r)*(v*v)*exp(B*(Re+h_0-r))*sin(bank)-Cl*S_ref*k1*p0*(r*r*r*r*r)*(v*v)*exp(B*(Re+h_0-r))*cos(bank)))/(m*v*cos(gamma)*2.0)+(a42*1.0/(r*r)*v*cos(gamma)*sin(azim))/cos(phi);
    adouble a42_dot = (Cl*S_ref*k2*p0*v*exp(B*(Re+h_0-r))*(a46*cos(bank)-a45*cos(gamma)*sin(bank))*(-1.0/2.0))/(m*cos(gamma));
    adouble a43_dot = -a46*((1.0/(r*r*r*r)*1.0/pow(cos(phi),2.0)*((r*r*r)*(v*v)*pow(cos(gamma),2.0)*sin(azim)-(Omega*Omega)*(r*r*r*r*r)*pow(cos(phi),2.0)*sin(azim)+(Omega*Omega)*(r*r*r*r*r)*pow(cos(phi),4.0)*sin(azim)*2.0-J2*(Re*Re)*mu*pow(cos(phi),2.0)*sin(azim)*3.0+J2*(Re*Re)*mu*pow(cos(phi),4.0)*sin(azim)*6.0+Omega*(r*r*r*r)*v*cos(gamma)*pow(cos(phi),3.0)*2.0+Omega*(r*r*r*r)*v*cos(azim)*pow(cos(phi),2.0)*sin(gamma)*sin(phi)*2.0))/(v*cos(gamma))+(Cl*S_ref*k3*p0*v*exp(B*(Re+h_0-r))*cos(bank))/(m*cos(gamma)*2.0))-a44*1.0/(r*r*r*r)*((Omega*Omega)*(r*r*r*r*r)*cos(azim)*cos(gamma)+J2*(Re*Re)*mu*cos(gamma*cos(azim))*3.0-(Omega*Omega)*(r*r*r*r*r)*cos(phi)*sin(gamma)*sin(phi)*2.0-(Omega*Omega)*(r*r*r*r*r)*cos(azim)*cos(gamma)*pow(cos(phi),2.0)*2.0-J2*(Re*Re)*mu*pow(cos(phi),2.0)*cos(gamma*cos(azim))*6.0+J2*(Re*Re)*mu*cos(phi)*sin(gamma)*sin(phi)*9.0)+(a45*1.0/(r*r*r*r)*(Omega*m*(r*r*r*r)*v*sin(azim)*sin(phi)*4.0-(Omega*Omega)*m*(r*r*r*r*r)*cos(azim)*pow(cos(phi),2.0)*sin(gamma)*2.0+(Omega*Omega)*m*(r*r*r*r*r)*cos(azim)*sin(gamma)*pow(sin(phi),2.0)*2.0+(Omega*Omega)*m*(r*r*r*r*r)*cos(gamma)*cos(phi)*sin(phi)*4.0-J2*(Re*Re)*m*mu*cos(azim)*pow(cos(phi),2.0)*sin(gamma)*6.0+J2*(Re*Re)*m*mu*cos(azim)*sin(gamma)*pow(sin(phi),2.0)*6.0-J2*(Re*Re)*m*mu*cos(gamma)*cos(phi)*sin(phi)*1.8E+1+Cl*S_ref*k3*p0*(r*r*r*r)*(v*v)*exp(B*(Re+h_0-r))*sin(bank)))/(m*v*2.0)-(a42*v*cos(gamma)*1.0/pow(cos(phi),2.0)*sin(azim)*sin(phi))/r;
    adouble a44_dot = -a41*sin(gamma)-(a43*cos(azim)*cos(gamma))/r+(a45*1.0/(r*r*r*r)*1.0/(v*v)*(m*(r*r*r)*(v*v)*cos(gamma)*-2.0-m*mu*(r*r)*cos(gamma)*2.0+J2*(Re*Re)*m*mu*cos(gamma)*6.0+(Omega*Omega)*m*(r*r*r*r*r)*cos(gamma)*pow(cos(phi),2.0)*2.0-J2*(Re*Re)*m*mu*cos(gamma)*pow(cos(phi),2.0)*9.0+(Omega*Omega)*m*(r*r*r*r*r)*cos(azim)*cos(phi)*sin(gamma)*sin(phi)*2.0-Cl*S_ref*p0*(r*r*r*r)*(v*v)*exp(B*(Re+h_0-r))*cos(bank)+Cl*S_ref*k4*p0*(r*r*r*r)*(v*v*v)*exp(B*(Re+h_0-r))*sin(bank)+J2*(Re*Re)*m*mu*cos(azim)*cos(phi)*sin(gamma)*sin(phi)*6.0))/(m*2.0)-(a42*cos(gamma)*sin(azim))/(r*cos(phi))-(a46*1.0/(r*r*r*r)*1.0/(v*v)*(m*(r*r*r)*(v*v)*pow(cos(gamma),2.0)*sin(azim)*sin(phi)*2.0+(Omega*Omega)*m*(r*r*r*r*r)*sin(azim)*sin(phi)*(pow(sin(phi),2.0)-1.0)*2.0+J2*(Re*Re)*m*mu*sin(azim)*sin(phi)*(pow(sin(phi),2.0)-1.0)*6.0+Cl*S_ref*p0*(r*r*r*r)*(v*v)*exp(B*(Re+h_0-r))*cos(phi)*sin(bank)+Cl*S_ref*k4*p0*(r*r*r*r)*(v*v*v)*exp(B*(Re+h_0-r))*cos(bank)*cos(phi)))/(m*cos(gamma)*cos(phi)*2.0)+(Cd*S_ref*a44*p0*v*exp(B*(Re+h_0-r)))/m;
    adouble a45_dot = -a44*((Omega*Omega)*r*cos(phi)*(cos(gamma)*cos(phi)+cos(azim)*sin(gamma)*sin(phi))+mu*1.0/(r*r)*cos(gamma)*(J2*(Re*Re)*1.0/(r*r)*(pow(sin(phi),2.0)*(9.0/2.0)-3.0/2.0)-1.0)+J2*(Re*Re)*mu*1.0/(r*r*r*r)*cos(azim)*cos(phi)*sin(phi)*sin(gamma*cos(azim))*3.0)-a46*((1.0/(r*r*r*r)*1.0/pow(cos(gamma),2.0)*(Omega*m*(r*r*r*r)*v*cos(azim)*pow(cos(phi),2.0)*-4.0+(Omega*Omega)*m*(r*r*r*r*r)*pow(cos(phi),2.0)*sin(azim)*sin(gamma)*sin(phi)*2.0-m*(r*r*r)*(v*v)*pow(cos(gamma),2.0)*sin(azim)*sin(gamma)*sin(phi)*2.0+J2*(Re*Re)*m*mu*pow(cos(phi),2.0)*sin(azim)*sin(gamma)*sin(phi)*6.0+Cl*S_ref*p0*(r*r*r*r)*(v*v)*exp(B*(Re+h_0-r))*cos(phi)*sin(bank)*sin(gamma)))/(m*v*cos(phi)*2.0)+(Cl*S_ref*k5*p0*v*exp(B*(Re+h_0-r))*cos(bank))/(m*cos(gamma)*2.0))+a45*((sin(gamma)*((v*v)/r+mu*1.0/(r*r)*(J2*(Re*Re)*1.0/(r*r)*(pow(sin(phi),2.0)*(9.0/2.0)-3.0/2.0)-1.0))+(Omega*Omega)*r*cos(phi)*(cos(phi)*sin(gamma)-cos(azim)*cos(gamma)*sin(phi))-J2*(Re*Re)*mu*1.0/(r*r*r*r)*cos(azim)*cos(gamma)*cos(phi)*sin(phi)*3.0)/v+(Cl*S_ref*k5*p0*v*exp(B*(Re+h_0-r))*sin(bank))/(m*2.0))-a41*v*cos(gamma)+(a43*v*cos(azim)*sin(gamma))/r+(a42*v*sin(azim)*sin(gamma))/(r*cos(phi));
    adouble a46_dot = a45*((1.0/(r*r*r*r)*cos(phi)*(Omega*(r*r*r*r)*v*cos(azim)*-2.0+(Omega*Omega)*(r*r*r*r*r)*sin(azim)*sin(gamma)*sin(phi)+J2*(Re*Re)*mu*sin(azim)*sin(gamma)*sin(phi)*3.0))/v+(Cl*S_ref*k6*p0*v*exp(B*(Re+h_0-r))*sin(bank))/(m*2.0))+(a43*v*cos(gamma)*sin(azim))/r-a44*1.0/(r*r*r*r)*cos(phi)*sin(azim)*sin(phi)*((Omega*Omega)*(r*r*r*r*r)*cos(gamma)-J2*(Re*Re)*gamma*mu*sin(gamma*cos(azim))*3.0)-(a46*1.0/(r*r*r*r)*(m*(r*r*r)*(v*v)*cos(azim)*pow(cos(gamma),2.0)*tan(phi)*2.0+(Omega*Omega)*m*(r*r*r*r*r)*cos(azim)*cos(phi)*sin(phi)*2.0+J2*(Re*Re)*m*mu*cos(azim)*cos(phi)*sin(phi)*6.0+Omega*m*(r*r*r*r)*v*cos(phi)*sin(azim)*sin(gamma)*4.0+Cl*S_ref*k6*p0*(r*r*r*r)*(v*v)*exp(B*(Re+h_0-r))*cos(bank)))/(m*v*cos(gamma)*2.0)-(a42*v*cos(azim)*cos(gamma))/(r*cos(phi));
    adouble a47_dot = (Cd*S_ref*a44*(v*v)*exp(B*(Re+h_0-r)))/(m*2.0)-(Cl*S_ref*a45*v*exp(B*(Re+h_0-r))*(cos(bank)-k7*p0*sin(bank)))/(m*2.0)-(Cl*S_ref*a46*v*exp(B*(Re+h_0-r))*(sin(bank)+k7*p0*cos(bank)))/(m*cos(gamma)*2.0);
    adouble a51_dot = -a54*((Omega*Omega)*cos(phi)*(cos(phi)*sin(gamma)-cos(azim)*cos(gamma)*sin(phi))-mu*1.0/(r*r*r)*sin(gamma)*(J2*(Re*Re)*1.0/(r*r)*(pow(sin(phi),2.0)*(9.0/2.0)-3.0/2.0)-1.0)*2.0-J2*(Re*Re)*mu*1.0/(r*r*r*r*r)*sin(gamma)*(pow(sin(phi),2.0)*(9.0/2.0)-3.0/2.0)*2.0+(B*Cd*S_ref*p0*(v*v)*exp(B*(Re+h_0-r)))/(m*2.0)+J2*(Re*Re)*mu*1.0/(r*r*r*r*r)*cos(phi)*sin(phi)*cos(gamma*cos(azim))*1.2E+1)+a55*((cos(gamma)*(1.0/(r*r)*(v*v)+mu*1.0/(r*r*r)*(J2*(Re*Re)*1.0/(r*r)*(pow(sin(phi),2.0)*(9.0/2.0)-3.0/2.0)-1.0)*2.0+J2*(Re*Re)*mu*1.0/(r*r*r*r*r)*(pow(sin(phi),2.0)*(9.0/2.0)-3.0/2.0)*2.0)-(Omega*Omega)*cos(phi)*(cos(gamma)*cos(phi)+cos(azim)*sin(gamma)*sin(phi))+(B*Cl*S_ref*p0*(v*v)*exp(B*(Re+h_0-r))*cos(bank))/(m*2.0)+J2*(Re*Re)*mu*1.0/(r*r*r*r*r)*cos(azim)*cos(phi)*sin(gamma)*sin(phi)*1.2E+1)/v+(Cl*S_ref*k1*p0*v*exp(B*(Re+h_0-r))*sin(bank))/(m*2.0))+a53*1.0/(r*r)*v*cos(azim)*cos(gamma)+(a56*1.0/(r*r*r*r*r)*((Omega*Omega)*m*(r*r*r*r*r)*cos(phi)*sin(azim)*sin(phi)*-2.0+(m*(r*r*r)*(v*v)*pow(cos(gamma),2.0)*sin(azim)*sin(phi)*2.0)/cos(phi)+J2*(Re*Re)*m*mu*cos(phi)*sin(azim)*sin(phi)*2.4E+1+B*Cl*S_ref*p0*(r*r*r*r*r)*(v*v)*exp(B*(Re+h_0-r))*sin(bank)-Cl*S_ref*k1*p0*(r*r*r*r*r)*(v*v)*exp(B*(Re+h_0-r))*cos(bank)))/(m*v*cos(gamma)*2.0)+(a52*1.0/(r*r)*v*cos(gamma)*sin(azim))/cos(phi);
    adouble a52_dot = (Cl*S_ref*k2*p0*v*exp(B*(Re+h_0-r))*(a56*cos(bank)-a55*cos(gamma)*sin(bank))*(-1.0/2.0))/(m*cos(gamma));
    adouble a53_dot = -a56*((1.0/(r*r*r*r)*1.0/pow(cos(phi),2.0)*((r*r*r)*(v*v)*pow(cos(gamma),2.0)*sin(azim)-(Omega*Omega)*(r*r*r*r*r)*pow(cos(phi),2.0)*sin(azim)+(Omega*Omega)*(r*r*r*r*r)*pow(cos(phi),4.0)*sin(azim)*2.0-J2*(Re*Re)*mu*pow(cos(phi),2.0)*sin(azim)*3.0+J2*(Re*Re)*mu*pow(cos(phi),4.0)*sin(azim)*6.0+Omega*(r*r*r*r)*v*cos(gamma)*pow(cos(phi),3.0)*2.0+Omega*(r*r*r*r)*v*cos(azim)*pow(cos(phi),2.0)*sin(gamma)*sin(phi)*2.0))/(v*cos(gamma))+(Cl*S_ref*k3*p0*v*exp(B*(Re+h_0-r))*cos(bank))/(m*cos(gamma)*2.0))-a54*1.0/(r*r*r*r)*((Omega*Omega)*(r*r*r*r*r)*cos(azim)*cos(gamma)+J2*(Re*Re)*mu*cos(gamma*cos(azim))*3.0-(Omega*Omega)*(r*r*r*r*r)*cos(phi)*sin(gamma)*sin(phi)*2.0-(Omega*Omega)*(r*r*r*r*r)*cos(azim)*cos(gamma)*pow(cos(phi),2.0)*2.0-J2*(Re*Re)*mu*pow(cos(phi),2.0)*cos(gamma*cos(azim))*6.0+J2*(Re*Re)*mu*cos(phi)*sin(gamma)*sin(phi)*9.0)+(a55*1.0/(r*r*r*r)*(Omega*m*(r*r*r*r)*v*sin(azim)*sin(phi)*4.0-(Omega*Omega)*m*(r*r*r*r*r)*cos(azim)*pow(cos(phi),2.0)*sin(gamma)*2.0+(Omega*Omega)*m*(r*r*r*r*r)*cos(azim)*sin(gamma)*pow(sin(phi),2.0)*2.0+(Omega*Omega)*m*(r*r*r*r*r)*cos(gamma)*cos(phi)*sin(phi)*4.0-J2*(Re*Re)*m*mu*cos(azim)*pow(cos(phi),2.0)*sin(gamma)*6.0+J2*(Re*Re)*m*mu*cos(azim)*sin(gamma)*pow(sin(phi),2.0)*6.0-J2*(Re*Re)*m*mu*cos(gamma)*cos(phi)*sin(phi)*1.8E+1+Cl*S_ref*k3*p0*(r*r*r*r)*(v*v)*exp(B*(Re+h_0-r))*sin(bank)))/(m*v*2.0)-(a52*v*cos(gamma)*1.0/pow(cos(phi),2.0)*sin(azim)*sin(phi))/r;
    adouble a54_dot = -a51*sin(gamma)-(a53*cos(azim)*cos(gamma))/r+(a55*1.0/(r*r*r*r)*1.0/(v*v)*(m*(r*r*r)*(v*v)*cos(gamma)*-2.0-m*mu*(r*r)*cos(gamma)*2.0+J2*(Re*Re)*m*mu*cos(gamma)*6.0+(Omega*Omega)*m*(r*r*r*r*r)*cos(gamma)*pow(cos(phi),2.0)*2.0-J2*(Re*Re)*m*mu*cos(gamma)*pow(cos(phi),2.0)*9.0+(Omega*Omega)*m*(r*r*r*r*r)*cos(azim)*cos(phi)*sin(gamma)*sin(phi)*2.0-Cl*S_ref*p0*(r*r*r*r)*(v*v)*exp(B*(Re+h_0-r))*cos(bank)+Cl*S_ref*k4*p0*(r*r*r*r)*(v*v*v)*exp(B*(Re+h_0-r))*sin(bank)+J2*(Re*Re)*m*mu*cos(azim)*cos(phi)*sin(gamma)*sin(phi)*6.0))/(m*2.0)-(a52*cos(gamma)*sin(azim))/(r*cos(phi))-(a56*1.0/(r*r*r*r)*1.0/(v*v)*(m*(r*r*r)*(v*v)*pow(cos(gamma),2.0)*sin(azim)*sin(phi)*2.0+(Omega*Omega)*m*(r*r*r*r*r)*sin(azim)*sin(phi)*(pow(sin(phi),2.0)-1.0)*2.0+J2*(Re*Re)*m*mu*sin(azim)*sin(phi)*(pow(sin(phi),2.0)-1.0)*6.0+Cl*S_ref*p0*(r*r*r*r)*(v*v)*exp(B*(Re+h_0-r))*cos(phi)*sin(bank)+Cl*S_ref*k4*p0*(r*r*r*r)*(v*v*v)*exp(B*(Re+h_0-r))*cos(bank)*cos(phi)))/(m*cos(gamma)*cos(phi)*2.0)+(Cd*S_ref*a54*p0*v*exp(B*(Re+h_0-r)))/m;
    adouble a55_dot = -a54*((Omega*Omega)*r*cos(phi)*(cos(gamma)*cos(phi)+cos(azim)*sin(gamma)*sin(phi))+mu*1.0/(r*r)*cos(gamma)*(J2*(Re*Re)*1.0/(r*r)*(pow(sin(phi),2.0)*(9.0/2.0)-3.0/2.0)-1.0)+J2*(Re*Re)*mu*1.0/(r*r*r*r)*cos(azim)*cos(phi)*sin(phi)*sin(gamma*cos(azim))*3.0)-a56*((1.0/(r*r*r*r)*1.0/pow(cos(gamma),2.0)*(Omega*m*(r*r*r*r)*v*cos(azim)*pow(cos(phi),2.0)*-4.0+(Omega*Omega)*m*(r*r*r*r*r)*pow(cos(phi),2.0)*sin(azim)*sin(gamma)*sin(phi)*2.0-m*(r*r*r)*(v*v)*pow(cos(gamma),2.0)*sin(azim)*sin(gamma)*sin(phi)*2.0+J2*(Re*Re)*m*mu*pow(cos(phi),2.0)*sin(azim)*sin(gamma)*sin(phi)*6.0+Cl*S_ref*p0*(r*r*r*r)*(v*v)*exp(B*(Re+h_0-r))*cos(phi)*sin(bank)*sin(gamma)))/(m*v*cos(phi)*2.0)+(Cl*S_ref*k5*p0*v*exp(B*(Re+h_0-r))*cos(bank))/(m*cos(gamma)*2.0))+a55*((sin(gamma)*((v*v)/r+mu*1.0/(r*r)*(J2*(Re*Re)*1.0/(r*r)*(pow(sin(phi),2.0)*(9.0/2.0)-3.0/2.0)-1.0))+(Omega*Omega)*r*cos(phi)*(cos(phi)*sin(gamma)-cos(azim)*cos(gamma)*sin(phi))-J2*(Re*Re)*mu*1.0/(r*r*r*r)*cos(azim)*cos(gamma)*cos(phi)*sin(phi)*3.0)/v+(Cl*S_ref*k5*p0*v*exp(B*(Re+h_0-r))*sin(bank))/(m*2.0))-a51*v*cos(gamma)+(a53*v*cos(azim)*sin(gamma))/r+(a52*v*sin(azim)*sin(gamma))/(r*cos(phi));
    adouble a56_dot = a55*((1.0/(r*r*r*r)*cos(phi)*(Omega*(r*r*r*r)*v*cos(azim)*-2.0+(Omega*Omega)*(r*r*r*r*r)*sin(azim)*sin(gamma)*sin(phi)+J2*(Re*Re)*mu*sin(azim)*sin(gamma)*sin(phi)*3.0))/v+(Cl*S_ref*k6*p0*v*exp(B*(Re+h_0-r))*sin(bank))/(m*2.0))+(a53*v*cos(gamma)*sin(azim))/r-a54*1.0/(r*r*r*r)*cos(phi)*sin(azim)*sin(phi)*((Omega*Omega)*(r*r*r*r*r)*cos(gamma)-J2*(Re*Re)*gamma*mu*sin(gamma*cos(azim))*3.0)-(a56*1.0/(r*r*r*r)*(m*(r*r*r)*(v*v)*cos(azim)*pow(cos(gamma),2.0)*tan(phi)*2.0+(Omega*Omega)*m*(r*r*r*r*r)*cos(azim)*cos(phi)*sin(phi)*2.0+J2*(Re*Re)*m*mu*cos(azim)*cos(phi)*sin(phi)*6.0+Omega*m*(r*r*r*r)*v*cos(phi)*sin(azim)*sin(gamma)*4.0+Cl*S_ref*k6*p0*(r*r*r*r)*(v*v)*exp(B*(Re+h_0-r))*cos(bank)))/(m*v*cos(gamma)*2.0)-(a52*v*cos(azim)*cos(gamma))/(r*cos(phi));
    adouble a57_dot = (Cd*S_ref*a54*(v*v)*exp(B*(Re+h_0-r)))/(m*2.0)-(Cl*S_ref*a55*v*exp(B*(Re+h_0-r))*(cos(bank)-k7*p0*sin(bank)))/(m*2.0)-(Cl*S_ref*a56*v*exp(B*(Re+h_0-r))*(sin(bank)+k7*p0*cos(bank)))/(m*cos(gamma)*2.0);
...
////////////////////////////////////////////////////////////////////////////
    ...
    problem.phases(iphase).bounds.lower.EndTime    = 100;
    problem.phases(iphase).bounds.upper.EndTime    = 100; 
    ...
    problem.phases(iphase).bounds.lower.StartTime    = 100;
    problem.phases(iphase).bounds.upper.StartTime    = 100;
