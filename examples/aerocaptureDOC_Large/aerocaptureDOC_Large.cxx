...
double s51 = -(cos(gamma)*(1.0/(r*r)*(v*v)+mu*1.0/(r*r*r)*(J2*(Re*Re)*1.0/(r*r)*(pow(sin(phi),2.0)*(9.0/2.0)-3.0/2.0)-1.0)*2.0+J2*(Re*Re)*mu*1.0/(r*r*r*r*r)*(pow(sin(phi),2.0)*(9.0/2.0)-3.0/2.0)*2.0)-(Omega*Omega)*cos(phi)*(cos(gamma)*cos(phi)+cos(azim)*sin(gamma)*sin(phi))+(B*Cl*S_ref*p0*(v*v)*exp(B*(Re+h_0-r))*cos(bank))/(m*2.0)+J2*(Re*Re)*mu*1.0/(r*r*r*r*r)*cos(azim)*cos(phi)*sin(gamma)*sin(phi)*1.2E+1)/v+(Cl*S_ref*k1*p0*v*exp(B*(Re+h_0-r))*sin(bank)*(bank-bank_min)*(bank-bank_max)*1.0/pow(bank_min-bank_max,2.0)*2.0)/m;
double s52 = (Cl*S_ref*k2*p0*v*exp(B*(Re+h_0-r))*sin(bank)*(bank-bank_min)*(bank-bank_max)*1.0/pow(bank_min-bank_max,2.0)*2.0)/m;
double s53 = -(1.0/(r*r*r*r)*((Omega*Omega)*(r*r*r*r*r)*cos(azim)*sin(gamma)+(Omega*Omega)*(r*r*r*r*r)*cos(gamma)*cos(phi)*sin(phi)*2.0+J2*(Re*Re)*mu*cos(azim)*sin(gamma)*3.0+Omega*(r*r*r*r)*v*sin(azim)*sin(phi)*2.0-(Omega*Omega)*(r*r*r*r*r)*cos(azim)*pow(cos(phi),2.0)*sin(gamma)*2.0-J2*(Re*Re)*mu*cos(gamma)*cos(phi)*sin(phi)*9.0-J2*(Re*Re)*mu*cos(azim)*pow(cos(phi),2.0)*sin(gamma)*6.0))/v+(Cl*S_ref*k3*p0*v*exp(B*(Re+h_0-r))*sin(bank)*(bank-bank_min)*(bank-bank_max)*1.0/pow(bank_min-bank_max,2.0)*2.0)/m;
double s54 = -1.0/(v*v)*(cos(gamma)*((v*v)/r+mu*1.0/(r*r)*(J2*(Re*Re)*1.0/(r*r)*(pow(sin(phi),2.0)*(9.0/2.0)-3.0/2.0)-1.0))+(Omega*Omega)*r*cos(phi)*(cos(gamma)*cos(phi)+cos(azim)*sin(gamma)*sin(phi))+Omega*v*cos(phi)*sin(azim)*2.0+(Cl*S_ref*p0*(v*v)*exp(B*(Re+h_0-r))*cos(bank))/(m*2.0)+J2*(Re*Re)*mu*1.0/(r*r*r*r)*cos(azim)*cos(phi)*sin(gamma)*sin(phi)*3.0)+(Omega*cos(phi)*sin(azim)*2.0+(v*cos(gamma)*2.0)/r+(Cl*S_ref*p0*v*exp(B*(Re+h_0-r))*cos(bank))/m)/v+(Cl*S_ref*k4*p0*v*exp(B*(Re+h_0-r))*sin(bank)*(bank-bank_min)*(bank-bank_max)*1.0/pow(bank_min-bank_max,2.0)*2.0)/m;
double s55 = -(sin(gamma)*((v*v)/r+mu*1.0/(r*r)*(J2*(Re*Re)*1.0/(r*r)*(pow(sin(phi),2.0)*(9.0/2.0)-3.0/2.0)-1.0))+(Omega*Omega)*r*cos(phi)*(cos(phi)*sin(gamma)-cos(azim)*cos(gamma)*sin(phi))-J2*(Re*Re)*mu*1.0/(r*r*r*r)*cos(azim)*cos(gamma)*cos(phi)*sin(phi)*3.0)/v+(Cl*S_ref*k5*p0*v*exp(B*(Re+h_0-r))*sin(bank)*(bank-bank_min)*(bank-bank_max)*1.0/pow(bank_min-bank_max,2.0)*2.0)/m;
double s56 = -(1.0/(r*r*r*r)*cos(phi)*(Omega*(r*r*r*r)*v*cos(azim)*-2.0+(Omega*Omega)*(r*r*r*r*r)*sin(azim)*sin(gamma)*sin(phi)+J2*(Re*Re)*mu*sin(azim)*sin(gamma)*sin(phi)*3.0))/v+(Cl*S_ref*k6*p0*v*exp(B*(Re+h_0-r))*sin(bank)*(bank-bank_min)*(bank-bank_max)*1.0/pow(bank_min-bank_max,2.0)*2.0)/m;
double s57 = (Cl*S_ref*v*exp(B*(Re+h_0-r))*cos(bank))/(m*2.0)+(Cl*S_ref*k7*p0*v*exp(B*(Re+h_0-r))*sin(bank)*(bank-bank_min)*(bank-bank_max)*1.0/pow(bank_min-bank_max,2.0)*2.0)/m;
double s61 = (1.0/(r*r*r*r*r)*(m*(r*r*r)*(v*v)*pow(cos(gamma),2.0)*sin(azim)*sin(phi)*2.0+(Omega*Omega)*m*(r*r*r*r*r)*sin(azim)*sin(phi)*(pow(sin(phi),2.0)-1.0)*2.0-J2*(Re*Re)*m*mu*sin(azim)*sin(phi)*(pow(sin(phi),2.0)-1.0)*2.4E+1+B*Cl*S_ref*p0*(r*r*r*r*r)*(v*v)*exp(B*(Re+h_0-r))*cos(phi)*sin(bank))*(-1.0/2.0))/(m*v*cos(gamma)*cos(phi))-(Cl*S_ref*k1*p0*v*exp(B*(Re+h_0-r))*cos(bank)*(bank-bank_min)*(bank-bank_max)*1.0/pow(bank_min-bank_max,2.0)*2.0)/(m*cos(gamma));
double s62 = (Cl*S_ref*k2*p0*v*exp(B*(Re+h_0-r))*cos(bank)*(bank-bank_min)*(bank-bank_max)*1.0/pow(bank_min-bank_max,2.0)*-2.0)/(m*cos(gamma));
...
double s66 = (1.0/(r*r*r*r)*((Omega*Omega)*(r*r*r*r*r)*cos(azim)*pow(cos(phi),2.0)*sin(phi)+(r*r*r)*(v*v)*cos(azim)*pow(cos(gamma),2.0)*sin(phi)+J2*(Re*Re)*mu*cos(azim)*pow(cos(phi),2.0)*sin(phi)*3.0+Omega*(r*r*r*r)*v*pow(cos(phi),2.0)*sin(azim)*sin(gamma)*2.0))/(v*cos(gamma)*cos(phi))-(Cl*S_ref*k6*p0*v*exp(B*(Re+h_0-r))*cos(bank)*(bank-bank_min)*(bank-bank_max)*1.0/pow(bank_min-bank_max,2.0)*2.0)/(m*cos(gamma));
double s67 = (Cl*S_ref*v*exp(B*(Re+h_0-r))*sin(bank))/(m*cos(gamma)*2.0)-(Cl*S_ref*k7*p0*v*exp(B*(Re+h_0-r))*cos(bank)*(bank-bank_min)*(bank-bank_max)*1.0/pow(bank_min-bank_max,2.0)*2.0)/(m*cos(gamma));
double s71 = 0.0;
double s72 = 0.0;
double s73 = 0.0;
double s74 = 0.0;
...
adouble s52 = (Cl*S_ref*k2*p0*v*exp(B*(Re+h_0-r))*sin(bank)*(bank-bank_min)*(bank-bank_max)*1.0/pow(bank_min-bank_max,2.0)*2.0)/m;
adouble s53 = -(1.0/(r*r*r*r)*((Omega*Omega)*(r*r*r*r*r)*cos(azim)*sin(gamma)+(Omega*Omega)*(r*r*r*r*r)*cos(gamma)*cos(phi)*sin(phi)*2.0+J2*(Re*Re)*mu*cos(azim)*sin(gamma)*3.0+Omega*(r*r*r*r)*v*sin(azim)*sin(phi)*2.0-(Omega*Omega)*(r*r*r*r*r)*cos(azim)*pow(cos(phi),2.0)*sin(gamma)*2.0-J2*(Re*Re)*mu*cos(gamma)*cos(phi)*sin(phi)*9.0-J2*(Re*Re)*mu*cos(azim)*pow(cos(phi),2.0)*sin(gamma)*6.0))/v+(Cl*S_ref*k3*p0*v*exp(B*(Re+h_0-r))*sin(bank)*(bank-bank_min)*(bank-bank_max)*1.0/pow(bank_min-bank_max,2.0)*2.0)/m;
adouble s54 = -1.0/(v*v)*(cos(gamma)*((v*v)/r+mu*1.0/(r*r)*(J2*(Re*Re)*1.0/(r*r)*(pow(sin(phi),2.0)*(9.0/2.0)-3.0/2.0)-1.0))+(Omega*Omega)*r*cos(phi)*(cos(gamma)*cos(phi)+cos(azim)*sin(gamma)*sin(phi))+Omega*v*cos(phi)*sin(azim)*2.0+(Cl*S_ref*p0*(v*v)*exp(B*(Re+h_0-r))*cos(bank))/(m*2.0)+J2*(Re*Re)*mu*1.0/(r*r*r*r)*cos(azim)*cos(phi)*sin(gamma)*sin(phi)*3.0)+(Omega*cos(phi)*sin(azim)*2.0+(v*cos(gamma)*2.0)/r+(Cl*S_ref*p0*v*exp(B*(Re+h_0-r))*cos(bank))/m)/v+(Cl*S_ref*k4*p0*v*exp(B*(Re+h_0-r))*sin(bank)*(bank-bank_min)*(bank-bank_max)*1.0/pow(bank_min-bank_max,2.0)*2.0)/m;
adouble s55 = -(sin(gamma)*((v*v)/r+mu*1.0/(r*r)*(J2*(Re*Re)*1.0/(r*r)*(pow(sin(phi),2.0)*(9.0/2.0)-3.0/2.0)-1.0))+(Omega*Omega)*r*cos(phi)*(cos(phi)*sin(gamma)-cos(azim)*cos(gamma)*sin(phi))-J2*(Re*Re)*mu*1.0/(r*r*r*r)*cos(azim)*cos(gamma)*cos(phi)*sin(phi)*3.0)/v+(Cl*S_ref*k5*p0*v*exp(B*(Re+h_0-r))*sin(bank)*(bank-bank_min)*(bank-bank_max)*1.0/pow(bank_min-bank_max,2.0)*2.0)/m;
adouble s56 = -(1.0/(r*r*r*r)*cos(phi)*(Omega*(r*r*r*r)*v*cos(azim)*-2.0+(Omega*Omega)*(r*r*r*r*r)*sin(azim)*sin(gamma)*sin(phi)+J2*(Re*Re)*mu*sin(azim)*sin(gamma)*sin(phi)*3.0))/v+(Cl*S_ref*k6*p0*v*exp(B*(Re+h_0-r))*sin(bank)*(bank-bank_min)*(bank-bank_max)*1.0/pow(bank_min-bank_max,2.0)*2.0)/m;
adouble s57 = (Cl*S_ref*v*exp(B*(Re+h_0-r))*cos(bank))/(m*2.0)+(Cl*S_ref*k7*p0*v*exp(B*(Re+h_0-r))*sin(bank)*(bank-bank_min)*(bank-bank_max)*1.0/pow(bank_min-bank_max,2.0)*2.0)/m;
adouble s61 = (1.0/(r*r*r*r*r)*(m*(r*r*r)*(v*v)*pow(cos(gamma),2.0)*sin(azim)*sin(phi)*2.0+(Omega*Omega)*m*(r*r*r*r*r)*sin(azim)*sin(phi)*(pow(sin(phi),2.0)-1.0)*2.0-J2*(Re*Re)*m*mu*sin(azim)*sin(phi)*(pow(sin(phi),2.0)-1.0)*2.4E+1+B*Cl*S_ref*p0*(r*r*r*r*r)*(v*v)*exp(B*(Re+h_0-r))*cos(phi)*sin(bank))*(-1.0/2.0))/(m*v*cos(gamma)*cos(phi))-(Cl*S_ref*k1*p0*v*exp(B*(Re+h_0-r))*cos(bank)*(bank-bank_min)*(bank-bank_max)*1.0/pow(bank_min-bank_max,2.0)*2.0)/(m*cos(gamma));
adouble s62 = (Cl*S_ref*k2*p0*v*exp(B*(Re+h_0-r))*cos(bank)*(bank-bank_min)*(bank-bank_max)*1.0/pow(bank_min-bank_max,2.0)*-2.0)/(m*cos(gamma));
adouble s63 = (1.0/(r*r*r*r)*1.0/pow(cos(phi),2.0)*((r*r*r)*(v*v)*pow(cos(gamma),2.0)*sin(azim)-(Omega*Omega)*(r*r*r*r*r)*pow(cos(phi),2.0)*sin(azim)+(Omega*Omega)*(r*r*r*r*r)*pow(cos(phi),4.0)*sin(azim)*2.0-J2*(Re*Re)*mu*pow(cos(phi),2.0)*sin(azim)*3.0+J2*(Re*Re)*mu*pow(cos(phi),4.0)*sin(azim)*6.0+Omega*(r*r*r*r)*v*cos(gamma)*pow(cos(phi),3.0)*2.0+Omega*(r*r*r*r)*v*cos(azim)*pow(cos(phi),2.0)*sin(gamma)*sin(phi)*2.0))/(v*cos(gamma))-(Cl*S_ref*k3*p0*v*exp(B*(Re+h_0-r))*cos(bank)*(bank-bank_min)*(bank-bank_max)*1.0/pow(bank_min-bank_max,2.0)*2.0)/(m*cos(gamma));
adouble s64 = (Omega*(sin(phi)-cos(azim)*cos(phi)*tan(gamma))*2.0+(v*cos(gamma)*sin(azim)*tan(phi)*2.0)/r+(Cl*S_ref*p0*v*exp(B*(Re+h_0-r))*sin(bank))/(m*cos(gamma)))/v-1.0/(v*v)*(Omega*v*(sin(phi)-cos(azim)*cos(phi)*tan(gamma))*2.0+((v*v)*cos(gamma)*sin(azim)*tan(phi))/r+((Omega*Omega)*r*cos(phi)*sin(azim)*sin(phi))/cos(gamma)+(J2*(Re*Re)*mu*1.0/(r*r*r*r)*cos(phi)*sin(azim)*sin(phi)*3.0)/cos(gamma)+(Cl*S_ref*p0*(v*v)*exp(B*(Re+h_0-r))*sin(bank))/(m*cos(gamma)*2.0))-(Cl*S_ref*k4*p0*v*exp(B*(Re+h_0-r))*cos(bank)*(bank-bank_min)*(bank-bank_max)*1.0/pow(bank_min-bank_max,2.0)*2.0)/(m*cos(gamma));
adouble s65 = (1.0/(r*r*r*r)*1.0/pow(cos(gamma),2.0)*(Omega*m*(r*r*r*r)*v*cos(azim)*pow(cos(phi),2.0)*-4.0+(Omega*Omega)*m*(r*r*r*r*r)*pow(cos(phi),2.0)*sin(azim)*sin(gamma)*sin(phi)*2.0-m*(r*r*r)*(v*v)*pow(cos(gamma),2.0)*sin(azim)*sin(gamma)*sin(phi)*2.0+J2*(Re*Re)*m*mu*pow(cos(phi),2.0)*sin(azim)*sin(gamma)*sin(phi)*6.0+Cl*S_ref*p0*(r*r*r*r)*(v*v)*exp(B*(Re+h_0-r))*cos(phi)*sin(bank)*sin(gamma)))/(m*v*cos(phi)*2.0)-(Cl*S_ref*k5*p0*v*exp(B*(Re+h_0-r))*cos(bank)*(bank-bank_min)*(bank-bank_max)*1.0/pow(bank_min-bank_max,2.0)*2.0)/(m*cos(gamma));
adouble s66 = (1.0/(r*r*r*r)*((Omega*Omega)*(r*r*r*r*r)*cos(azim)*pow(cos(phi),2.0)*sin(phi)+(r*r*r)*(v*v)*cos(azim)*pow(cos(gamma),2.0)*sin(phi)+J2*(Re*Re)*mu*cos(azim)*pow(cos(phi),2.0)*sin(phi)*3.0+Omega*(r*r*r*r)*v*pow(cos(phi),2.0)*sin(azim)*sin(gamma)*2.0))/(v*cos(gamma)*cos(phi))-(Cl*S_ref*k6*p0*v*exp(B*(Re+h_0-r))*cos(bank)*(bank-bank_min)*(bank-bank_max)*1.0/pow(bank_min-bank_max,2.0)*2.0)/(m*cos(gamma));
adouble s67 = (Cl*S_ref*v*exp(B*(Re+h_0-r))*sin(bank))/(m*cos(gamma)*2.0)-(Cl*S_ref*k7*p0*v*exp(B*(Re+h_0-r))*cos(bank)*(bank-bank_min)*(bank-bank_max)*1.0/pow(bank_min-bank_max,2.0)*2.0)/(m*cos(gamma));
adouble s71 = 0.0;
adouble s72 = 0.0;
adouble s73 = 0.0;
adouble s74 = 0.0;
...
////////////////////////////////////////////////////////////////////////////
    ...
    double a11_min  =-39.7452000000000;
    double a12_min  =-59.7386000000000;
    double a13_min  =-1642.69000000000;
    double a14_min  =-267.712000000000;
    double a15_min  =-16125800;
    double a16_min  =-135968;
    double a17_min  =-540854;
    double a21_min  =-5.95726000000000e-06;
    double a22_min  =-10;
    double a23_min  =-0.0529693000000000;
    double a24_min  =-2.63694000000000e-05;
    double a25_min  =-1.22718000000000;
    double a26_min  =-5.02178000000000;
    double a27_min  =-0.0590107000000000;
    double a31_min  =-3.77642000000000e-05;
    double a32_min  =-8.15954000000000e-06;
    double a33_min  =-10;
    double a34_min  =-0.000569222000000000;
    double a35_min  =-34.9583000000000;
    double a36_min  =-0.146333000000000;
    double a37_min  =-0.325945000000000;
    double a41_min  =-1.01528000000000;
    double a42_min  =-0.431156000000000;
    double a43_min  =-101.275000000000;
    double a44_min  =-13.0960000000000;
    double a45_min  =-920965;
    double a46_min  =-5049.03000000000;
    double a47_min  =-10161.9000000000;
    double a51_min  =-4.40308000000000e-05;
    double a52_min  =-3.73145000000000e-05;
    double a53_min  =-0.00251662000000000;
    double a54_min  =-0.000372154000000000;
    double a55_min  =-32.9471000000000;
    double a56_min  =-0.318531000000000;
    double a57_min  =-0.517590000000000;
    double a61_min  =-3.66676000000000e-05;
    double a62_min  =-6.81387000000000e-05;
    double a63_min  =-0.364791000000000;
    double a64_min  =-0.000121844000000000;
    double a65_min  =-7.05578000000000;
    double a66_min  =-10.0275000000000;
    double a67_min  =-0.307095000000000;
    double a71_min  =-0;
    double a72_min  =-0;
    double a73_min  =-0;
    double a74_min  =-0;
    ...
    double a11_max  =39.7452000000000;
    double a12_max  =59.7386000000000;
    double a13_max  =1642.69000000000;
    double a14_max  =267.712000000000;
    double a15_max  =16125800;
    double a16_max  =135968;
    double a17_max  =540854;
    double a21_max  =5.95726000000000e-06;
    double a22_max  =10;
    double a23_max  =0.0529693000000000;
    double a24_max  =2.63694000000000e-05;
    double a25_max  =1.22718000000000;
    double a26_max  =5.02178000000000;
    double a27_max  =0.0590107000000000;
    double a31_max  =3.77642000000000e-05;
    double a32_max  =8.15954000000000e-06;
    double a33_max  =10;
    double a34_max  =0.000569222000000000;
    double a35_max  =34.9583000000000;
    double a36_max  =0.146333000000000;
    double a37_max  =0.325945000000000;
    double a41_max  =1.01528000000000;
    double a42_max  =0.431156000000000;
    double a43_max  =101.275000000000;
    double a44_max  =13.0960000000000;
    double a45_max  =920965;
    double a46_max  =5049.03000000000;
    double a47_max  =10161.9000000000;
    double a51_max  =4.40308000000000e-05;
    double a52_max  =3.73145000000000e-05;
    double a53_max  =0.00251662000000000;
    double a54_max  =0.000372154000000000;
    double a55_max  =32.9471000000000;
    double a56_max  =0.318531000000000;
    double a57_max  =0.517590000000000;
    double a61_max  =3.66676000000000e-05;
    double a62_max  =6.81387000000000e-05;
    double a63_max  =0.364791000000000;
    double a64_max  =0.000121844000000000;
    double a65_max  =7.05578000000000;
    double a66_max  =10.0275000000000;
    double a67_max  =0.307095000000000;
    double a71_max  =0;
    double a72_max  =0;
    double a73_max  =0;
    double a74_max  =0;
...
////////////////////////////////////////////////////////////////////////////
    ...
    u_guess.row(1)  =1e-3*ones(1,nnodes);
    u_guess.row(2)  =1e-3*ones(1,nnodes);
    u_guess.row(3)  =1e-3*ones(1,nnodes);
    u_guess.row(4)  =1e-3*ones(1,nnodes);
    u_guess.row(5)  =1e-3*ones(1,nnodes);
    u_guess.row(6)  =1e-3*ones(1,nnodes);
    u_guess.row(7)  =1e-3*ones(1,nnodes);
