                      ...
                      adouble* xad, int iphase, Workspace* workspace)
{
   ...
   if (iphase == 2)
        ...
        fval = 1e3*(sqrt((2*CONSTANTS.mu))*(sqrt(1/CONSTANTS.target_ap-1/(CONSTANTS.target_ap+ CONSTANTS.target_pp))-sqrt(1/CONSTANTS.target_ap-(2*CONSTANTS.mu-r_exit*pow(v_exit,2))/(2*CONSTANTS.mu*r_exit))));
                     ...
                     adouble& time, adouble* xad, int iphase, Workspace* workspace)
{
    double q = 1e-7;
    double r = 100;
    adouble runCost = q*(states[10]*states[10] + states[14]*states[14] + states[18]*states[18]) + r *(controls[1]*controls[1] + controls[2]*controls[2] +controls[3]*controls[3]);
    return  runCost;
}
...
////////////////////////////////////////////////////////////////////////////
    ...
    problem.phases(iphase).bounds.upper.EndTime    = 350.0; 
...
////////////////////////////////////////////////////////////////////////////
    ...
    u_guess.row(2)  = 0*ones(1,nnodes);
    u_guess.row(3)  = 0*ones(1,nnodes);
