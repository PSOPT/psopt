...
int main(void)
{
    ...
    problem.name = "Mixed-integer optimal control (SCIP backend)";
    problem.outfilename = "scip_miop.txt";
    ...
    problem.phases(1).nodes     << 31; // dt = 0.1 over T = 3
    ...
    problem.phases(1).guess.states   = zeros(2,31);
    problem.phases(1).guess.states.row(0) = linspace(0.0,1.0,31);
    problem.phases(1).guess.controls = zeros(2,31);
    problem.phases(1).guess.time     = linspace(0.0,3.0,31);
